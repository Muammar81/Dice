...
public class LevelConnectionManager : MonoBehaviourPunCallbacks
{
    ...
    {
        Debug.Log($"{otherPlayer.NickName} left. Exiting...");
    ...
    private IEnumerator RetryConnection(float delay)
    {
